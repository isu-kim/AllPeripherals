        ...
        for (int i = 0 ; i < DeviceCount ; i++){ // For save the information to the structure.
            ...
            switch (tempDevInfo->type) {
                case CDT_Mouse:
                    ...
                    cout << "Mouse : " << tempDevInfo->model << endl;
                ...
                case CDT_Keyboard:
                    ...
                    cout << "Keyboard : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                ...
                case CDT_Headset:
                    ...
                    cout << "Headset : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                ...
                case CDT_Cooler:
                    ...
                    AssignEtcLedArrays();
                    cout << "Cooler : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                    Connected.Etc = true;
                    break;
                ...
                case CDT_MouseMat:
                    ...
                    cout << "MouseMat : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                ...
                case CDT_CommanderPro:
                    ...
                    AssignEtcLedArrays();
                    cout << "CommanderPro : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                    Connected.Etc = true;
                    break;
                ...
                case CDT_HeadsetStand:
                    ...
                    cout << "HeadsetStand : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                ...
                case CDT_MemoryModule:
                    ...
                    AssignEtcLedArrays();
                    cout << "MemoryModule : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                    Connected.Etc = true;
                    break;
                ...
                case CDT_LightingNodePro:
                    ...
                    AssignEtcLedArrays();
                    cout << "LightingNodePro : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                    Connected.Etc = true;
                    break;
                ...
                case CDT_Unknown:
                    ...
                    AssignEtcLedArrays();
                    cout << "Unknown : " << tempDevInfo->model << endl;
                    cout << "Led Counts : " << tempDevInfo->ledsCount << endl;
                    Connected.Etc = true;
                    break;
