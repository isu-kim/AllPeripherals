...
namespace ChromaSDK
{
    ...
    namespace Keyboard
    {
        ...
        typedef enum EFFECT_TYPE
        {
            ...
            CHROMA_CUSTOM2,             //!< Custom effects with keys using 8x24 grid.
            CHROMA_INVALID              //!< Invalid effect.
        } EFFECT_TYPE;
        ...
        {
            COLORREF Color[MAX_ROW][MAX_COLUMN];        //!< Grid layout. 6 rows by 22 columns.
            COLORREF Key[MAX_ROW][MAX_COLUMN];          //!< Keys information. 6 rows by 22 columns. To indicate there is a key effect, OR with 0x01000000. i.e. Key[0][1] = 0x01000000 | Color;
        ...
        namespace v2
        {
            //! Maximum number of rows in an extended keyboard.
            const RZSIZE MAX_ROW = 8;

            //! Maximum number of columns in an extended keyboard.
            const RZSIZE MAX_COLUMN = 24;

            //! Custom effect with keys for an extended keyboard.
            typedef struct CUSTOM_EFFECT_TYPE
            {
                COLORREF Color[MAX_ROW][MAX_COLUMN];                    //!< Grid layout. 8 rows by 24 columns.
                COLORREF Key[Keyboard::MAX_ROW][Keyboard::MAX_COLUMN];  //!< Keys information. 6 rows by 22 columns. To indicate there is a key effect, OR with 0x01000000. i.e. Key[0][1] = 0x01000000 | Color;
            } CUSTOM_EFFECT_TYPE;
        }
    }
    ...
    namespace Mousepad
    {
        ...
        typedef enum EFFECT_TYPE
        {
            ...
            CHROMA_STATIC,              //!< Static single color effect.
            CHROMA_WAVE,                //!< Wave effect (Deprecated and should not be used).
            CHROMA_CUSTOM2,             //!< Custom effect with 20 virtual LEDs. First element starts from top-right and it goes clockwise full circle with 5 LEDs on each side.
            CHROMA_INVALID,             //!< Invalid effect.
        } EFFECT_TYPE;
