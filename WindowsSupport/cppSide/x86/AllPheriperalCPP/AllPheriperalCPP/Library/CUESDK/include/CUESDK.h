...
#define CORSAIR_LIGHTING_SDK_DISABLE_DEPRECATION_WARNINGS // We need to define this macro in order to not get any warnings about using DIY device control functions.
